...
namespace Updog.Application {
    ...
    /// </summary>
    public sealed class SpaceFinderDefault : IInteractor<SpaceFindByDefaultParams, IEnumerable<SpaceView>> {
        #region Fields
        ...
        public async Task<IEnumerable<SpaceView>> Handle(SpaceFindByDefaultParams input) {
